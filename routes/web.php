...
Route::redirect('/youtobe', '/pzn');

Route::fallback(function (){
    return "404 by Programmer Zaman Now";
});

Route::view('/hello', 'hello', ['name' => 'Akbar']); //sama yang dibawah

Route::get('/hello-again', function (){
    return view('hello', ['name' => 'Akbar']);
});
...
//    return route('redirect-hello', ['name' => 'Akbar']);
//    return url()->route('/redirect-hello', ['name' => 'Akbar']);
   return \Illuminate\Support\Facades\URL::class('redirect-hello', ['name' => 'Akbar']);
});
